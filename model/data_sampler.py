...
class DataSampler(object):
    ...
    def sample_original_condvec(self, batch):
        ...
        for i in range(batch):
            ...
            matrix_st = self._discrete_column_matrix_st[col_idx] # 변수에서 하나 선택
            matrix_ed = matrix_st + self._discrete_column_n_category[col_idx] # 변수별 카테고리 개수에서 하나 선택
    ...
    def sample_data(self, n, col, opt):
        ...
        for c, o in zip(col, opt):
            idx.append(np.random.choice(self._rid_by_cat_cols[c][o])) # idx 는 샘플링된 real 데이터들의 인덱스
